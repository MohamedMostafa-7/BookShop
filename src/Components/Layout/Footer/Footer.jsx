                ...
                <div className='max-w-345 h-92.5 mx-auto flex flex-col justify-center gap-4 flex-wrap '>
                    <div className='md:flex items-center justify-between w-full '>
                        <div className='md:flex items-center gap-10'>
                            ...
                            <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 text-white border border-gray-200 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0">

                                <li>
                                    <Link to="/" class="block py-2 px-3 bg-[#EAA451] rounded md:bg-transparent md:text-[#EAA451] md:p-0">
                                        Home
                                    </Link>
                                </li>

                                <li>
                                    <Link to="books" class="block py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#EAA451] md:p-0">
                                        Books
                                    </Link>
                                </li>

                                <li>
                                    <Link to="aboutus" class="block py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#EAA451] md:p-0">
                                        About us
                                    </Link>
                                </li>
                            </ul>
                        ...
                        <div className='flex items-center gap-6'>
                            ...
                            <a href="">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_11288_1416)">
